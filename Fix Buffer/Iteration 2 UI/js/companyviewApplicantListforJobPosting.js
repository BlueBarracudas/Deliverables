<script>
    ...
    function add_job_item() {
            ...
            var $newjobpostion = $('<p class="job-position">Applicant.name</p>');
            $newcol2.append($newjobpostion);
            var $newcol3 = $('<div class="col-md-3"></div>');
            var $newlist = $('<ul></ul>');
            var $newlistitem = $('<li>applicant.Detail</li>');
            ...
            var $newcol4 = $('<div class="col-md-4 col-md-offset-1"></div>');
            var $newbtngroup = $('<div class="btn-group"></div>');
            var $editbtn = $('<button type="button" class="btn" onclick="edit_enter()">Set Appointment</button>');
            var $deletebtn = $('<button type="button" class="btn delete-btn" onclick="delete_job_item(this)">Reject Applicant</button>');

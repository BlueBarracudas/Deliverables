		      	...
		      	'<li class="dropdown">'+
		          	...
		          	'<ul class="dropdown-menu" id="notifications" role="menu">'+
			            '<div class="list-group scrollable-menu">'+
						  ...
						  '<a href="#" class="list-group-item">Vestibulum at eros <div class="timestamp" align="right">12:47pm</div></a>'+
						'</div>'+
						'<a id="notif" href="#applicantnotif" data-toggle="tab"><center>Notification Settings</center></a>'+
	        		'</ul>'+
			        '<li class="dropdown">'+
	          		'<a id="dropdownComponent" href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Apllicant Name  <span class="caret"></span></a>'+
